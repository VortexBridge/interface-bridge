import { a as mt, b as S, s as J, i as G, H as At, d as T, K as D, C as Z, c as O, M as U, n as W, E as z } from "./index-6261c055.js";
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const De = window, Xn = De.ShadowRoot && (De.ShadyCSS === void 0 || De.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, tr = Symbol(), lr = /* @__PURE__ */ new WeakMap();
let Jr = class {
  constructor(t, n, i) {
...
const Mi = (e) => new Jr(typeof e == "string" ? e : e + "", void 0, tr), _ = (e, ...t) => {
 ...
 */
var Je;
const Be = window, dr = Be.trustedTypes, Ni = dr ? dr.emptyScript : "", hr = Be.reactiveElementPolyfillSupport, Un = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Ni : null;
      break;
  ...
  return n;
} }, Qr = (e, t) => t !== e && (t == t || e == e), Qe = { attribute: !0, type: String, converter: Un, reflect: !1, hasChanged: Qr }, Hn = "finalized";
let Dt = class extends HTMLElement {
  ...
  createRenderRoot() {
    ...
    return Si(n, this.constructor.elementStyles), n;
  }
  connectedCallback() {
    var t;
  ...
  _$EO(t, n, i = Qe) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const a = (((r = i.converter) === null || r === void 0 ? void 0 : r.toAttribute) !== void 0 ? i.converter : Un).toAttribute(n, i.type);
  ...
  _$AK(t, n) {
    ...
    if (o !== void 0 && this._$El !== o) {
      const a = r.getPropertyOptions(o), l = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((i = a.converter) === null || i === void 0 ? void 0 : i.fromAttribute) !== void 0 ? a.converter : Un;
...
Dt[Hn] = !0, Dt.elementProperties = /* @__PURE__ */ new Map(), Dt.elementStyles = [], Dt.shadowRootOptions = { mode: "open" }, hr == null || hr({ ReactiveElement: Dt }), ((Je = Be.reactiveElementVersions) !== null && Je !== void 0 ? Je : Be.reactiveElementVersions = []).push("1.6.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var Xe;
const We = window, Ut = We.trustedTypes, ur = Ut ? Ut.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Zn = "$lit$", dt = `lit$${(Math.random() + "").slice(9)}$`, Xr = "?" + dt, Ri = `<${Xr}>`, kt = document, he = () => kt.createComment(""), ue = (e) => e === null || typeof e != "object" && typeof e != "function", ti = Array.isArray, Li = (e) => ti(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", tn = `[ 	
\f\r]`, Kt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, mr = /-->/g, pr = />/g, gt = RegExp(`>|${tn}(?:([^\\s"'>=/]+)(${tn}*=${tn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), gr = /'/g, fr = /"/g, ei = /^(?:script|style|textarea|title)$/i, ni = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), d = ni(1), M = ni(2), It = Symbol.for("lit-noChange"), H = Symbol.for("lit-nothing"), wr = /* @__PURE__ */ new WeakMap(), $t = kt.createTreeWalker(kt, 129, null, !1), ji = (e, t) => {
  ...
  for (let s = 0; s < n; s++) {
    ...
    for (; p < c.length && (a.lastIndex = p, u = a.exec(c), u !== null); )
      p = a.lastIndex, a === Kt ? u[1] === "!--" ? a = mr : u[1] !== void 0 ? a = pr : u[2] !== void 0 ? (ei.test(u[2]) && (r = RegExp("</" + u[2], "g")), a = gt) : u[3] !== void 0 && (a = gt) : a === gt ? u[0] === ">" ? (a = r ?? Kt, h = -1) : u[1] === void 0 ? h = -2 : (h = a.lastIndex - u[2].length, m = u[1], a = u[3] === void 0 ? gt : u[3] === '"' ? fr : gr) : a === fr || a === gr ? a = gt : a === mr || a === pr ? a = Kt : (a = gt, r = void 0);
    const A = a === gt && e[s + 1].startsWith("/>") ? " " : "";
    o += a === Kt ? c + Ri : h >= 0 ? (i.push(m), c.slice(0, h) + Zn + c.slice(h) + dt + A) : c + dt + (h === -2 ? (i.push(void 0), s) : A);
  }
  const l = o + (e[n] || "<?>") + (t === 2 ? "</svg>" : "");
  if (!Array.isArray(e) || !e.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return [ur !== void 0 ? ur.createHTML(l) : l, i];
};
let Vn = class ri {
  constructor({ strings: t, _$litType$: n }, i) {
    ...
    this.parts = [];
    let o = 0, a = 0;
    const l = t.length - 1, s = this.parts, [c, m] = ji(t, n);
    if (this.el = ri.createElement(c, i), $t.currentNode = this.el.content, n === 2) {
      ...
      if (r.nodeType === 1) {
        if (r.hasAttributes()) {
          ...
          for (const h of r.getAttributeNames())
            if (h.endsWith(Zn) || h.startsWith(dt)) {
              const p = m[a++];
              if (u.push(h), p !== void 0) {
                const A = r.getAttribute(p.toLowerCase() + Zn).split(dt), v = /([.?@])?(.*)/.exec(p);
                s.push({ type: 1, index: o, name: v[2], strings: A, ctor: v[1] === "." ? Bi : v[1] === "?" ? Ui : v[1] === "@" ? Hi : Fe });
              } else
        ...
        if (ei.test(r.tagName)) {
          const u = r.textContent.split(dt), h = u.length - 1;
          if (h > 0) {
            r.textContent = Ut ? Ut.emptyScript : "";
            for (let p = 0; p < h; p++)
              r.append(u[p], he()), $t.nextNode(), s.push({ type: 2, index: ++o });
            r.append(u[h], he());
          }
        }
...
class Di {
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (l === c.index) {
        let m;
        c.type === 2 ? m = new ge(a, a.nextSibling, this, t) : c.type === 1 ? m = new c.ctor(a, c.name, c.strings, this, t) : c.type === 6 && (m = new Zi(a, this, t)), this._$AV.push(m), c = r[++s];
      }
...
class ge {
  constructor(t, n, i, r) {
    var o;
    this.type = 2, this._$AH = H, this._$AN = void 0, this._$AA = t, this._$AB = n, this._$AM = i, this.options = r, this._$Cp = (o = r == null ? void 0 : r.isConnected) === null || o === void 0 || o;
  }
  get _$AU() {
    var t, n;
  ...
  _$AI(t, n = this) {
    t = Ht(this, t, n), ue(t) ? t === H || t == null || t === "" ? (this._$AH !== H && this._$AR(), this._$AH = H) : t !== this._$AH && t !== It && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Li(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== H && ue(this._$AH) ? this._$AA.nextSibling.data = t : this.$(kt.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var n;
    const { values: i, _$litType$: r } = t, o = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = Vn.createElement(r.h, this.options)), r);
  ...
  _$AC(t) {
    let n = wr.get(t.strings);
    return n === void 0 && wr.set(t.strings, n = new Vn(t)), n;
  }
  T(t) {
    ...
    let i, r = 0;
    for (const o of t)
      r === n.length ? n.push(i = new ge(this.k(he()), this.k(he()), this, this.options)) : i = n[r], i._$AI(o), r++;
...
class Fe {
  constructor(t, n, i, r, o) {
    this.type = 1, this._$AH = H, this._$AN = void 0, this.element = t, this.name = n, this._$AM = r, this.options = o, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = H;
  }
  get tagName() {
  ...
  _$AI(t, n = this, i, r) {
    ...
    if (o === void 0)
      ...
      for (t = o[0], s = 0; s < o.length - 1; s++)
        c = Ht(this, l[i + s], n, s), c === It && (c = this._$AH[s]), a || (a = !ue(c) || c !== this._$AH[s]), c === H ? t = H : t !== H && (t += (c ?? "") + o[s + 1]), this._$AH[s] = c;
    }
    a && !r && this.j(t);
  }
  j(t) {
...
const Wi = Ut ? Ut.emptyScript : "";
class Ui extends Fe {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== H ? this.element.setAttribute(this.name, Wi) : this.element.removeAttribute(this.name);
  }
}
class Hi extends Fe {
  constructor(t, n, i, r, o) {
  ...
  _$AI(t, n = this) {
    var i;
    if ((t = (i = Ht(this, t, n, 0)) !== null && i !== void 0 ? i : H) === It)
      return;
    const r = this._$AH, o = t === H && r !== H || t.capture !== r.capture || t.once !== r.once || t.passive !== r.passive, a = t !== H && (r === H || o);
...
const vr = We.litHtmlPolyfillSupport;
vr == null || vr(Vn, ge), ((Xe = We.litHtmlVersions) !== null && Xe !== void 0 ? Xe : We.litHtmlVersions = []).push("2.7.4");
const Vi = (e, t, n) => {
  var i, r;
  ...
  if (a === void 0) {
    ...
    o._$litPart$ = a = new ge(t.insertBefore(he(), l), l, void 0, n ?? {});
  }
  return a._$AI(e), a;
};
/**
...
let C = class extends Dt {
  ...
  update(t) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Vi(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
...
C.finalized = !0, C._$litElement$ = !0, (en = globalThis.litElementHydrateSupport) === null || en === void 0 || en.call(globalThis, { LitElement: C });
const br = globalThis.litElementPolyfillSupport;
br == null || br({ LitElement: C });
((nn = globalThis.litElementVersions) !== null && nn !== void 0 ? nn : globalThis.litElementVersions = []).push("3.3.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const zi = (e, t) => t.kind === "method" && t.descriptor && !("value" in t.descriptor) ? { ...t, finisher(n) {
...
function y(e) {
  return (t, n) => n !== void 0 ? Fi(e, t, n) : zi(e, t);
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 */
var rn;
((rn = window.HTMLSlotElement) === null || rn === void 0 ? void 0 : rn.prototype.assignedElements) != null;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Gi = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, Ki = (e) => (...t) => ({ _$litDirective$: e, values: t });
class qi {
  constructor(t) {
  }
  get _$AU() {
...
const ii = (e, t, n) => Math.min(Math.max(n, e), t), Y = {
  ...
  repeat: 0,
  easing: "ease"
}, Ue = (e) => typeof e == "number", Wt = (e) => Array.isArray(e) && !Ue(e[0]), Ji = (e, t, n) => {
  const i = t - e;
  return ((n - e) % i + i) % i + e;
};
function Qi(e, t) {
  return Wt(e) ? e[Ji(0, e.length, t)] : e;
}
...
function to(e, t = Xi(e.length), n = ut) {
  ...
  return r > 0 && si(t, r), (o) => {
    ...
    return l = Qi(n, a)(l), oi(e[a], e[a + 1], l);
  };
}
const li = (e) => Array.isArray(e) && Ue(e[0]), zn = (e) => typeof e == "object" && !!e.createAnimation, Zt = (e) => typeof e == "function", eo = (e) => typeof e == "string", ce = {
  ms: (e) => e * 1e3,
  s: (e) => e / 1e3
}, ci = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e, no = 1e-7, ro = 12;
function io(e, t, n, i, r) {
  let o, a, l = 0;
  do
    a = t + (n - t) / 2, o = ci(a, i, r) - e, o > 0 ? n = a : t = a;
  while (Math.abs(o) > no && ++l < ro);
  return a;
}
function le(e, t, n, i) {
  if (e === t && n === i)
...
function xr(e) {
  ...
  if (e.startsWith("steps")) {
    ...
    if (t) {
      const n = t[1].split(",");
      return oo(parseFloat(n[0]), n[1].trim());
    }
  }
  return ut;
}
class di {
  constructor(t, n = [0, 1], { easing: i, duration: r = Y.duration, delay: o = Y.delay, endDelay: a = Y.endDelay, repeat: l = Y.repeat, offset: s, direction: c = "normal" } = {}) {
    if (this.startTime = null, this.rate = 1, this.t = 0, this.cancelTimestamp = null, this.easing = ut, this.duration = 0, this.totalDuration = 0, this.repeat = 0, this.playState = "idle", this.finished = new Promise((u, h) => {
    ...
    const m = to(n, s, Wt(i) ? i.map(xr) : ut);
    this.tick = (u) => {
      var h;
      o = o;
      let p = 0;
      this.pauseTime !== void 0 ? p = this.pauseTime : p = (u - this.startTime) * this.rate, this.t = p, p /= 1e3, p = Math.max(p - o, 0), this.playState === "finished" && this.pauseTime === void 0 && (p = this.totalDuration);
      const A = p / this.duration;
      let v = Math.floor(A), k = A % 1;
      !k && A >= 1 && (k = 1), k === 1 && v--;
      const x = v % 2;
      (c === "reverse" || c === "alternate" && x || c === "alternate-reverse" && !x) && (k = 1 - k);
      const w = p >= this.totalDuration ? 1 : Math.min(k, 1), b = m(this.easing(w));
      t(b), this.pauseTime === void 0 && (this.playState === "finished" || p >= this.totalDuration + a) ? (this.playState = "finished", (h = this.resolve) === null || h === void 0 || h.call(this, b)) : this.playState !== "idle" && (this.frameRequestId = requestAnimationFrame(this.tick));
    }, this.play();
  }
  play() {
...
function hi(e) {
  return on.has(e) || on.set(e, {
    transforms: [],
    values: /* @__PURE__ */ new Map()
  }), on.get(e);
}
function lo(e, t) {
  return e.has(t) || e.set(t, new so()), e.get(t);
}
const co = ["", "X", "Y", "Z"], ho = ["translate", "scale", "rotate", "skew"], He = {
  x: "translateX",
  y: "translateY",
  z: "translateZ"
}, Cr = {
  ...
  skew: Cr
}, me = /* @__PURE__ */ new Map(), nr = (e) => `--motion-${e}`, Ze = ["x", "y", "z"];
ho.forEach((e) => {
  co.forEach((t) => {
    Ze.push(e + t), me.set(nr(e + t), uo[e]);
  });
});
const mo = (e, t) => Ze.indexOf(e) - Ze.indexOf(t), po = new Set(Ze), ui = (e) => po.has(e), go = (e, t) => {
  He[t] && (t = He[t]);
  const { transforms: n } = hi(e);
  Yi(n, t), e.style.transform = fo(n);
}, fo = (e) => e.sort(mo).reduce(wo, "").trim(), wo = (e, t) => `${e} ${t}(var(${nr(t)}))`, Gn = (e) => e.startsWith("--"), $r = /* @__PURE__ */ new Set();
function vo(e) {
  if (!$r.has(e)) {
    $r.add(e);
    try {
...
const an = (e, t) => document.createElement("div").animate(e, t), Er = {
  ...
  finished: () => !!an({ opacity: [0, 1] }, { duration: 1e-3 }).finished,
  linearEasing: () => {
    try {
      an({ opacity: 0 }, { easing: "linear(0, 1)" });
    } catch {
      return !1;
    }
    return !0;
...
for (const e in Er)
  Bt[e] = () => (sn[e] === void 0 && (sn[e] = Er[e]()), sn[e]);
const bo = 0.015, yo = (e, t) => {
  let n = "";
  const i = Math.round(t / bo);
  for (let r = 0; r < i; r++)
    n += e(er(0, i - 1, r)) + ", ";
  return n.substring(0, n.length - 2);
}, Ar = (e, t) => Zt(e) ? Bt.linearEasing() ? `linear(${yo(e, t)})` : Y.easing : li(e) ? xo(e) : e, xo = ([e, t, n, i]) => `cubic-bezier(${e}, ${t}, ${n}, ${i})`;
function Co(e, t) {
...
function Kn(e) {
  return He[e] && (e = He[e]), ui(e) ? nr(e) : e;
}
const ve = {
  get: (e, t) => {
    t = Kn(t);
...
function ko(e, t, n, i = {}, r) {
  const o = Ao(), a = i.record !== !1 && o;
  let l, { duration: s = Y.duration, delay: c = Y.delay, endDelay: m = Y.endDelay, repeat: u = Y.repeat, easing: h = Y.easing, persist: p = !1, direction: A, offset: v, allowWebkitAcceleration: k = !1 } = i;
  const x = hi(e), w = ui(t);
  let b = Bt.waapi();
  w && go(e, t);
  const f = Kn(t), P = lo(x.values, f), R = me.get(f);
  return mi(P.animation, !(zn(h) && P.generator) && i.record !== !1), () => {
    const B = () => {
      var j, X;
      return (X = (j = ve.get(e, f)) !== null && j !== void 0 ? j : R == null ? void 0 : R.initialValue) !== null && X !== void 0 ? X : 0;
    };
    let L = Co($o(n), B);
    const Q = Eo(L, R);
    if (zn(h)) {
      const j = h.createAnimation(L, t !== "opacity", B, f, P);
      h = j.easing, L = j.keyframes || L, s = j.duration || s;
    }
    if (Gn(f) && (Bt.cssRegisterProperty() ? vo(f) : b = !1), w && !Bt.linearEasing() && (Zt(h) || Wt(h) && h.some(Zt)) && (b = !1), b) {
      R && (L = L.map((tt) => Ue(tt) ? R.toDefaultUnit(tt) : tt)), L.length === 1 && (!Bt.partialKeyframes() || a) && L.unshift(B());
      const j = {
        delay: ce.ms(c),
        duration: ce.ms(s),
        endDelay: ce.ms(m),
        easing: Wt(h) ? void 0 : Ar(h, s),
        direction: A,
        iterations: u + 1,
        fill: "both"
      };
      ...
      ve.set(e, f, R && Ue(j) ? R.toDefaultUnit(j) : j);
    }
    return a && o(e, t, L, {
      duration: s,
      delay: c,
...
const _o = (e) => e(), pi = (e, t, n = Y.duration) => new Proxy({
  animations: e.map(_o).filter(Boolean),
  duration: n,
  options: t
}, Po), To = (e) => e.animations[0], Po = {
  get: (e, t) => {
    const n = To(e);
    switch (t) {
      case "duration":
      ...
      case "finished":
        return e.finished || (e.finished = Promise.all(e.animations.map(Mo)).catch(ai)), e.finished;
      case "stop":
        return () => {
...
function No(e) {
  return function(n, i, r = {}) {
    ...
    for (let l = 0; l < o; l++) {
      ...
      for (const c in i) {
        const m = Io(r, c);
        m.delay = So(m.delay, l, o);
        const u = ko(s, c, i[c], m, e);
        a.push(u);
      }
    }
    return pi(
...
we.prototype.set = function(e, t, n, i) {
...
we.prototype.xor = function(e, t, n) {
  this.data[e * this.size + t] ^= n;
};
we.prototype.isReserved = function(e, t) {
...
(function(e) {
  ...
  e.isValid = function(r) {
    ...
    const o = r.size;
    let a = 0, l = 0, s = 0, c = null, m = null;
    for (let u = 0; u < o; u++) {
      l = s = 0, c = m = null;
      for (let h = 0; h < o; h++) {
        let p = r.get(u, h);
        p === c ? l++ : (l >= 5 && (a += t.N1 + (l - 5)), c = p, l = 1), p = r.get(h, u), p === m ? s++ : (s >= 5 && (a += t.N1 + (s - 5)), m = p, s = 1);
      }
    ...
    for (let c = 0; c < o; c++) {
      l = s = 0;
      for (let m = 0; m < o; m++)
        l = l << 1 & 2047 | r.get(c, m), m >= 10 && (l === 1488 || l === 93) && a++, s = s << 1 & 2047 | r.get(m, c), m >= 10 && (s === 1488 || s === 93) && a++;
    }
    return a * t.N3;
  ...
  e.applyMask = function(r, o) {
    ...
    for (let c = 0; c < a; c++) {
      o(c), e.applyMask(c, r);
      const m = e.getPenaltyN1(r) + e.getPenaltyN2(r) + e.getPenaltyN3(r) + e.getPenaltyN4(r);
...
Ke.getBlocksCount = function(t, n) {
  switch (n) {
    case ht.L:
      return be[(t - 1) * 4 + 0];
    case ht.M:
...
Ke.getTotalCodewordsCount = function(t, n) {
  switch (n) {
    case ht.L:
      return ye[(t - 1) * 4 + 0];
    case ht.M:
...
pe = pe.replace(/u/g, "\\u");
const Vo = "(?:(?![A-Z0-9 $%*+\\-./:]|" + pe + `)(?:.|[\r
]))+`;
rt.KANJI = new RegExp(pe, "g");
rt.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g");
rt.BYTE = new RegExp(Vo, "g");
rt.NUMERIC = new RegExp($i, "g");
rt.ALPHANUMERIC = new RegExp(Zo, "g");
const zo = new RegExp("^" + pe + "$"), Fo = new RegExp("^" + $i + "$"), Go = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
(function(e) {
  const t = q, n = Ke, i = Ge, r = pt, o = or, a = 7973, l = t.getBCHDigit(a);
  function s(h, p, A) {
    for (let v = 1; v <= 40; v++)
      if (p <= e.getCapacity(v, A, h))
        return v;
  }
  function c(h, p) {
  ...
  function u(h, p) {
    for (let A = 1; A <= 40; A++)
      if (m(h, A) <= e.getCapacity(A, p, r.MIXED))
        return A;
  }
  e.from = function(p, A) {
    return o.isValid(p) ? parseInt(p, 10) : A;
  }, e.getCapacity = function(p, A, v) {
    if (!o.isValid(p))
      throw new Error("Invalid QR Code version");
    typeof v > "u" && (v = r.BYTE);
    const k = t.getSymbolTotalCodewords(p), x = n.getTotalCodewordsCount(p, A), w = (k - x) * 8;
    if (v === r.MIXED)
      return w;
    const b = w - c(v, p);
    switch (v) {
  ...
  }, e.getBestVersionForData = function(p, A) {
    let v;
    const k = i.from(A, i.M);
    if (Array.isArray(p)) {
      if (p.length > 1)
        return u(p, k);
      if (p.length === 0)
      ...
      v = p;
    return s(v.mode, v.getLength(), k);
  }, e.getEncodedBits = function(p) {
    if (!o.isValid(p) || p < 7)
      throw new Error("Invalid QR Code version");
    let A = p << 12;
    for (; t.getBCHDigit(A) - l >= 0; )
      A ^= a << t.getBCHDigit(A) - l;
    return p << 12 | A;
  };
})(Ci);
var Ei = {};
const qn = q, Ai = 1335, Ko = 21522, Ir = qn.getBCHDigit(Ai);
...
const qo = pt;
function Vt(e) {
  this.mode = qo.NUMERIC, this.data = e.toString();
}
...
function zt(e) {
  this.mode = Jo.ALPHANUMERIC, this.data = e;
}
...
zt.prototype.write = function(t) {
  ...
  for (n = 0; n + 2 <= this.data.length; n += 2) {
    let i = ln.indexOf(this.data[n]) * 45;
    i += ln.indexOf(this.data[n + 1]), t.put(i, 11);
  }
  this.data.length % 2 && t.put(ln.indexOf(this.data[n]), 6);
};
var Qo = zt, Xo = function(t) {
...
(function(e) {
  var t = {
    single_source_shortest_paths: function(n, i, r) {
      ...
      l.push(i, 0);
      for (var s, c, m, u, h, p, A, v, k; !l.empty(); ) {
        s = l.pop(), c = s.value, u = s.cost, h = n[c] || {};
        for (m in h)
          h.hasOwnProperty(m) && (p = h[m], A = u + p, v = a[m], k = typeof a[m] > "u", (k || v > A) && (a[m] = A, l.push(m, A), o[m] = c));
      }
      if (typeof r < "u" && typeof a[r] > "u") {
        var x = ["Could not find a path from ", i, " to ", r, "."].join("");
        throw new Error(x);
      }
      return o;
    },
    ...
    find_path: function(n, i, r) {
      var o = t.single_source_shortest_paths(n, i, r);
...
var aa = Ii.exports;
(function(e) {
  const t = pt, n = Yo, i = Qo, r = na, o = oa, a = rt, l = q, s = aa;
  function c(x) {
  ...
  function u(x) {
    const w = m(a.NUMERIC, t.NUMERIC, x), b = m(a.ALPHANUMERIC, t.ALPHANUMERIC, x);
    let f, P;
    return l.isKanjiModeEnabled() ? (f = m(a.BYTE, t.BYTE, x), P = m(a.KANJI, t.KANJI, x)) : (f = m(a.BYTE_KANJI, t.BYTE, x), P = []), w.concat(b, f, P).sort(function(B, L) {
  ...
  function p(x) {
    return x.reduce(function(w, b) {
      const f = w.length - 1 >= 0 ? w[w.length - 1] : null;
      return f && f.mode === b.mode ? (w[w.length - 1].data += b.data, w) : (w.push(b), w);
    }, []);
  }
  function A(x) {
    const w = [];
  ...
  function v(x, w) {
    ...
    for (let R = 0; R < x.length; R++) {
      ...
      for (let Q = 0; Q < B.length; Q++) {
        const j = B[Q], X = "" + R + Q;
        L.push(X), b[X] = { node: j, lastCount: 0 }, f[X] = {};
        for (let tt = 0; tt < P.length; tt++) {
          const et = P[tt];
          b[et] && b[et].node.mode === j.mode ? (f[et][X] = h(b[et].lastCount + j.length, j.mode) - h(b[et].lastCount, j.mode), b[et].lastCount += j.length) : (b[et] && (b[et].lastCount = j.length), f[et][X] = h(j.length, j.mode) + 4 + t.getCharCountIndicator(j.mode, w));
        }
      }
      P = L;
    }
  ...
  function k(x, w) {
    let b;
    const f = t.getBestModeForData(x);
    if (b = t.from(w, f), b !== t.BYTE && b.bit < f.bit)
      throw new Error('"' + x + '" cannot be encoded with mode ' + t.toString(b) + `.
 Suggested mode is: ` + t.toString(f));
  ...
  e.fromArray = function(w) {
    return w.reduce(function(b, f) {
      return typeof f == "string" ? b.push(k(f, null)) : f.data && b.push(k(f.data, f.mode)), b;
    }, []);
  }, e.fromString = function(w, b) {
    const f = u(w, l.isKanjiModeEnabled()), P = A(f), R = v(P, b), B = s.find_path(R.map, "start", "end"), L = [];
...
const Ye = q, cn = Ge, sa = Bo, la = Wo, ca = wi, da = vi, Yn = bi, Jn = Ke, ha = Ho, ze = Ci, ua = Ei, ma = pt, dn = ki;
function pa(e, t) {
  const n = e.size, i = da.getPositions(t);
...
function wa(e, t) {
  const n = e.size, i = ze.getEncodedBits(t);
  let r, o, a;
  for (let l = 0; l < 18; l++)
    r = Math.floor(l / 3), o = l % 3 + n - 8 - 3, a = (i >> l & 1) === 1, e.set(r, o, a, !0), e.set(o, r, a, !0);
}
function hn(e, t, n) {
  const i = e.size, r = ua.getEncodedBits(t, n);
  let o, a;
  for (o = 0; o < 15; o++)
...
function ba(e, t, n) {
  ...
  n.forEach(function(s) {
    i.put(s.mode.bit, 4), i.put(s.getLength(), ma.getCharCountIndicator(s.mode, e)), s.write(i);
  });
  const r = Ye.getSymbolTotalCodewords(e), o = Jn.getTotalCodewordsCount(e, t), a = (r - o) * 8;
...
function ya(e, t, n) {
  const i = Ye.getSymbolTotalCodewords(t), r = Jn.getTotalCodewordsCount(t, n), o = i - r, a = Jn.getBlocksCount(t, n), l = i % a, s = a - l, c = Math.floor(i / a), m = Math.floor(o / a), u = m + 1, h = c - m, p = new ha(h);
  let A = 0;
  const v = new Array(a), k = new Array(a);
  let x = 0;
  const w = new Uint8Array(e.buffer);
  for (let B = 0; B < a; B++) {
    const L = B < s ? m : u;
    v[B] = w.slice(A, A + L), k[B] = p.encode(v[B]), A += L, x = Math.max(x, L);
  }
  const b = new Uint8Array(i);
  let f = 0, P, R;
  for (P = 0; P < x; P++)
    for (R = 0; R < a; R++)
      P < v[R].length && (b[f++] = v[R][P]);
  for (P = 0; P < h; P++)
    for (R = 0; R < a; R++)
      b[f++] = k[R][P];
  return b;
...
function xa(e, t, n, i) {
  ...
  if (Array.isArray(e))
    ...
    let c = t;
    if (!c) {
      const m = dn.rawSplit(e);
      c = ze.getBestVersionForData(m, n);
    }
    r = dn.fromString(e, c || 40);
  } else
...
`
  ...
  const a = ba(t, n, r), l = Ye.getSymbolSize(t), s = new la(l);
  return pa(s, t), ga(s), fa(s, t), hn(s, n, 0), t >= 7 && wa(s, t), va(s, a), isNaN(i) && (i = Yn.getBestMask(
    s,
    hn.bind(null, s, n)
  )), Yn.applyMask(i, s), hn(s, n, i), {
    modules: s,
    version: t,
...
gi.create = function(t, n) {
  ...
  let i = cn.M, r, o;
  return typeof n < "u" && (i = cn.from(n.errorCorrectionLevel, cn.M), r = ze.from(n.version), o = Yn.from(n.maskPattern), n.toSJISFunc && Ye.setToSJISFunction(n.toSJISFunc)), xa(t, r, i, o);
};
var Oi = {}, ar = {};
(function(e) {
  function t(n) {
  ...
  e.getOptions = function(i) {
    ...
    const a = r.modules.size, l = r.modules.data, s = e.getScale(a, o), c = Math.floor((a + o.margin * 2) * s), m = o.margin * s, u = [o.color.light, o.color.dark];
    for (let h = 0; h < c; h++)
      for (let p = 0; p < c; p++) {
        let A = (h * c + p) * 4, v = o.color.light;
        if (h >= m && p >= m && h < c - m && p < c - m) {
          const k = Math.floor((h - m) / s), x = Math.floor((p - m) / s);
          v = u[l[k * a + x] ? 1 : 0];
        }
        i[A++] = v.r, i[A++] = v.g, i[A++] = v.b, i[A] = v.a;
      }
  };
})(ar);
(function(e) {
  ...
  e.render = function(o, a, l) {
    ...
    const m = t.getImageWidth(o.modules.size, s), u = c.getContext("2d"), h = u.createImageData(m, m);
    return t.qrToImageData(h.data, o, s), n(u, c, m), u.putImageData(h, 0, 0), c;
  }, e.renderToDataURL = function(o, a, l) {
    let s = l;
    typeof s > "u" && (!a || !a.getContext) && (s = a, a = void 0), s || (s = {});
    const c = e.render(o, a, s), m = s.type || "image/png", u = s.rendererOpts || {};
...
function $a(e, t, n) {
  ...
  for (let l = 0; l < e.length; l++) {
    ...
    !s && !o && (o = !0), e[l] ? (a++, l > 0 && s > 0 && e[l - 1] || (i += o ? un("M", s + n, 0.5 + c + n) : un("m", r, 0), r = 0, o = !1), s + 1 < t && e[l + 1] || (i += un("h", a), a = 0)) : r++;
  }
  return i;
}
_i.render = function(t, n, i) {
  const r = Ca.getOptions(n), o = t.modules.size, a = t.modules.data, l = o + r.margin * 2, s = r.color.light.a ? "<path " + Or(r.color.light, "fill") + ' d="M0 0h' + l + "v" + l + 'H0z"/>' : "", c = "<path " + Or(r.color.dark, "stroke") + ' d="' + $a(a, o, r.margin) + '"/>', m = 'viewBox="0 0 ' + l + " " + l + '"', h = '<svg xmlns="http://www.w3.org/2000/svg" ' + (r.width ? 'width="' + r.width + '" height="' + r.width + '" ' : "") + m + ' shape-rendering="crispEdges">' + s + c + `</svg>
`;
  return typeof i == "function" && i(null, h), h;
};
const Ea = jo, Qn = gi, Ti = Oi, Aa = _i;
...
fe.create = Qn.create;
fe.toCanvas = sr.bind(null, Ti.render);
fe.toDataURL = sr.bind(null, Ti.renderToDataURL);
fe.toString = sr.bind(null, function(e, t, n) {
  return Aa.render(e, n);
});
var ka = Object.defineProperty, _r = Object.getOwnPropertySymbols, Ia = Object.prototype.hasOwnProperty, Oa = Object.prototype.propertyIsEnumerable, Tr = (e, t, n) => t in e ? ka(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, xe = (e, t) => {
  for (var n in t || (t = {}))
    Ia.call(t, n) && Tr(e, n, t[n]);
  if (_r)
    for (var n of _r(t))
      Oa.call(t, n) && Tr(e, n, t[n]);
  return e;
};
function _a() {
  var e;
...
const I = { getPreset(e) {
  ...
  if (e) {
    const n = xe(xe(xe(xe({}, _a()), Pr()), t), Ta());
    Object.entries(n).forEach(([i, r]) => e.style.setProperty(i, r));
  }
}, globalCss: _`*,::after,::before{margin:0;padding:0;box-sizing:border-box;font-style:normal;text-rendering:optimizeSpeed;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-tap-highlight-color:transparent;backface-visibility:hidden}button{cursor:pointer;display:flex;justify-content:center;align-items:center;position:relative;border:none;background-color:transparent;transition:all .2s ease}@media (hover:hover) and (pointer:fine){button:active{transition:all .1s ease;transform:scale(.93)}}button::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;transition:background-color,.2s ease}button:disabled{cursor:not-allowed}button svg,button w3m-text{position:relative;z-index:1}input{border:none;outline:0;appearance:none}img{display:block}::selection{color:var(--w3m-accent-fill-color);background:var(--w3m-accent-color)}` }, Pa = _`button{display:flex;border-radius:var(--w3m-button-hover-highlight-border-radius);flex-direction:column;justify-content:center;padding:5px;width:100px}button:active{background-color:var(--w3m-color-overlay)}@media(hover:hover){button:hover{background-color:var(--w3m-color-overlay)}}button>div{display:flex;justify-content:center;align-items:center;width:32px;height:32px;box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);background-color:var(--w3m-accent-color);border-radius:var(--w3m-icon-button-border-radius);margin-bottom:4px}button path{fill:var(--w3m-accent-fill-color)}`;
var Ma = Object.defineProperty, Sa = Object.getOwnPropertyDescriptor, Ce = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Sa(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Ma(t, n, r), r;
};
...
at.styles = [I.globalCss, Na], _t([y()], at.prototype, "disabled", 2), _t([y()], at.prototype, "iconLeft", 2), _t([y()], at.prototype, "iconRight", 2), _t([y()], at.prototype, "onClick", 2), _t([y()], at.prototype, "variant", 2), at = _t([$("w3m-button")], at);
const ja = _`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--w3m-button-border-radius);color:var(--w3m-accent-fill-color);background-color:var(--w3m-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--w3m-color-overlay)}button:active::after{background-color:var(--w3m-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--w3m-color-bg-3);color:var(--w3m-color-fg-3)}.w3m-secondary{color:var(--w3m-accent-color);background-color:transparent}.w3m-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--w3m-color-overlay)}}`;
var Da = Object.defineProperty, Ba = Object.getOwnPropertyDescriptor, mn = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Ba(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
qt.styles = [I.globalCss, ja], mn([y()], qt.prototype, "disabled", 2), mn([y()], qt.prototype, "variant", 2), qt = mn([$("w3m-button-big")], qt);
const Wa = _`:host{background-color:var(--w3m-color-bg-2);border-top:1px solid var(--w3m-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
var Ua = Object.defineProperty, Ha = Object.getOwnPropertyDescriptor, Za = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Ha(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Ua(t, n, r), r;
};
...
$e.styles = [I.globalCss, Va], Mr([N()], $e.prototype, "isHelp", 2), $e = Mr([$("w3m-modal-backcard")], $e);
const Ga = _`main{padding:20px;padding-top:0;width:100%}`;
var Ka = Object.defineProperty, qa = Object.getOwnPropertyDescriptor, Ya = (e, t, n, i) => {
...
gn.styles = [I.globalCss, Ga], gn = Ya([$("w3m-modal-content")], gn);
const Ja = _`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--w3m-color-bg-2)}`;
var Qa = Object.defineProperty, Xa = Object.getOwnPropertyDescriptor, ts = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Xa(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
fn.styles = [I.globalCss, Ja], fn = ts([$("w3m-modal-footer")], fn);
...
var ns = Object.defineProperty, rs = Object.getOwnPropertyDescriptor, Yt = (e, t, n, i) => {
...
ft.styles = [I.globalCss, es], Yt([y()], ft.prototype, "title", 2), Yt([y()], ft.prototype, "onAction", 2), Yt([y()], ft.prototype, "actionIcon", 2), Yt([y()], ft.prototype, "border", 2), ft = Yt([$("w3m-modal-header")], ft);
const is = { 1: "692ed6ba-e569-459a-556a-776476829e00", 42161: "600a9a04-c1b9-42ca-6785-9b4b6ff85200", 43114: "30c46e53-e989-45fb-4549-be3bd4eb3b00", 56: "93564157-2e8e-4ce7-81df-b264dbee9b00", 250: "06b26297-fe0c-4733-5d6b-ffa5498aac00", 10: "ab9c186a-c52f-464b-2906-ca59d760a400", 137: "41d04d42-da3b-4453-8506-668cc0727900", 100: "02b53f6a-e3d4-479e-1cb4-21178987d100", 9001: "f926ff41-260d-4028-635e-91913fc28e00", 324: "b310f07f-4ef7-49f3-7073-2a0a39685800", 314: "5a73b3dd-af74-424e-cae0-0de859ee9400", 4689: "34e68754-e536-40da-c153-6ef2e7188a00", 1088: "3897a66d-40b9-4833-162f-a2c90531c900", 1284: "161038da-44ae-4ec7-1208-0ea569454b00", 1285: "f1d73bb6-5450-4e18-38f7-fb6484264a00" }, os = { ETH: { icon: "692ed6ba-e569-459a-556a-776476829e00" }, WETH: { icon: "692ed6ba-e569-459a-556a-776476829e00" }, AVAX: { icon: "30c46e53-e989-45fb-4549-be3bd4eb3b00" }, FTM: { icon: "06b26297-fe0c-4733-5d6b-ffa5498aac00" }, BNB: { icon: "93564157-2e8e-4ce7-81df-b264dbee9b00" }, MATIC: { icon: "41d04d42-da3b-4453-8506-668cc0727900" }, OP: { icon: "ab9c186a-c52f-464b-2906-ca59d760a400" }, xDAI: { icon: "02b53f6a-e3d4-479e-1cb4-21178987d100" }, EVMOS: { icon: "f926ff41-260d-4028-635e-91913fc28e00" }, METIS: { icon: "3897a66d-40b9-4833-162f-a2c90531c900" }, IOTX: { icon: "34e68754-e536-40da-c153-6ef2e7188a00" } }, K = { externalWallets() {
  ...
  var e, t;
  const { mobileWallets: n, desktopWallets: i } = z.state, r = (e = K.recentWallet()) == null ? void 0 : e.id, o = O.isMobile() ? n : i, a = o == null ? void 0 : o.filter((l) => r !== l.id);
  return (t = O.isMobile() ? a == null ? void 0 : a.map(({ id: l, name: s, links: c }) => ({ id: l, name: s, mobile: c, links: c })) : a == null ? void 0 : a.map(({ id: l, name: s, links: c }) => ({ id: l, name: s, desktop: c, links: c }))) != null ? t : [];
  ...
  const { isStandalone: e } = T.state, { explorerExcludedWalletIds: t, explorerRecommendedWalletIds: n } = z.state, i = O.isMobile();
  if (e || t === "ALL" || i)
    return [];
  const { namespace: r } = Z.client(), { injectedWallets: o } = W.state;
  return o.filter(({ id: a, injected: l }) => {
    const s = O.isArray(t) ? t : [], c = O.isArray(n) ? n : [];
    return !!l.some((m) => m.namespace === r && !s.includes(a) && !c.includes(a));
  });
}, recentWallet() {
...
} }, g = { MOBILE_BREAKPOINT: 600, W3M_RECENT_WALLET_DATA: "W3M_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", rejectStandaloneButtonComponent() {
  const { isStandalone: e } = T.state;
  if (e)
  ...
  var t;
  const n = is[e], { projectId: i, chainImages: r } = z.state;
  return (t = r == null ? void 0 : r[e]) != null ? t : i && n ? W.getAssetImageUrl(n) : "";
}, getTokenIcon(e) {
  var t, n;
  const i = (t = os[e]) == null ? void 0 : t.icon, { projectId: r, tokenImages: o } = z.state;
  ...
  const { standaloneUri: t } = T.state, { pairingUri: n } = U.state, { mobile: i, name: r } = e, o = i == null ? void 0 : i.native, a = i == null ? void 0 : i.universal;
  g.setRecentWallet(e);
  function l(s) {
    let c = "";
    o ? c = O.formatUniversalUrl(o, s, r) : a && (c = O.formatNativeUrl(a, s, r)), O.openHref(c, "_self");
  }
  l(t || n);
}, handleAndroidLinking() {
  const { standaloneUri: e } = T.state, { pairingUri: t } = U.state;
  e ? (O.setWalletConnectAndroidDeepLink(e), O.openHref(e, "_self")) : (O.setWalletConnectAndroidDeepLink(t), O.openHref(t, "_self"));
}, async handleUriCopy() {
  const { standaloneUri: e } = T.state, { pairingUri: t } = U.state;
  ...
  try {
    ...
    console.error(n), t ? t() : G.openToast(g.getErrorMessage(n), "error");
  }
}, getCustomImageUrls() {
  ...
  localStorage.setItem(g.W3M_RECENT_WALLET_DATA, JSON.stringify({ [t]: e }));
}, getRecentWallet() {
  ...
  const { id: e, desktop: t, mobile: n, injected: i } = O.getWalletRouterData(), r = K.installedInjectedWallets(), o = !!(i != null && i.length), a = r.some((m) => m.id === e), l = !!(t != null && t.native), s = !!(t != null && t.universal), c = !!(n != null && n.native) || !!(n != null && n.universal);
  return { isInjectedInstalled: a, isInjected: o, isDesktop: l, isMobile: c, isWeb: s };
}, goToConnectingView(e) {
  S.setData({ Wallet: e });
  const t = O.isMobile(), { isDesktop: n, isWeb: i, isMobile: r, isInjectedInstalled: o } = g.getCachedRouterWalletPlatforms();
...
} }, as = _`.w3m-router{overflow:hidden;will-change:transform}.w3m-content{display:flex;flex-direction:column}`;
var ss = Object.defineProperty, ls = Object.getOwnPropertyDescriptor, wn = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? ls(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
Jt.styles = [I.globalCss, as], wn([N()], Jt.prototype, "view", 2), wn([N()], Jt.prototype, "prevView", 2), Jt = wn([$("w3m-modal-router")], Jt);
const cs = _`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--w3m-notification-border-radius);border:1px solid var(--w3m-color-overlay);background-color:var(--w3m-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--w3m-color-bg-3)}}.w3m-success path{fill:var(--w3m-accent-color)}.w3m-error path{fill:var(--w3m-error-color)}`;
var ds = Object.defineProperty, hs = Object.getOwnPropertyDescriptor, Sr = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? hs(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && ds(t, n, r), r;
};
...
Ae.styles = [I.globalCss, gs], Nr([y()], Ae.prototype, "chainId", 2), Ae = Nr([$("w3m-network-image")], Ae);
const vs = 0.1, Rr = 2.5, it = 7;
function vn(e, t, n) {
  return e === t ? !1 : (e - t < 0 ? t - e : e - t) <= n + vs;
}
function bs(e, t) {
...
const ys = { generate(e, t, n, i) {
  const r = i === "light" ? "#141414" : "#fff", o = i === "light" ? "#fff" : "#141414", a = [], l = bs(e, "Q"), s = t / l.length, c = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
  c.forEach(({ x: v, y: k }) => {
    const x = (l.length - it) * s * v, w = (l.length - it) * s * k, b = 0.32;
    for (let f = 0; f < c.length; f += 1) {
      const P = s * (it - f * 2);
      a.push(M`<rect fill="${f % 2 === 0 ? r : o}" height="${P}" rx="${P * b}" ry="${P * b}" width="${P}" x="${x + s * f}" y="${w + s * f}">`);
    }
  });
  const m = Math.floor((n + 25) / s), u = l.length / 2 - m / 2, h = l.length / 2 + m / 2 - 1, p = [];
  l.forEach((v, k) => {
    v.forEach((x, w) => {
      if (l[k][w] && !(k < it && w < it || k > l.length - (it + 1) && w < it || k < it && w > l.length - (it + 1)) && !(k > u && k < h && w > u && w < h)) {
        const b = k * s + s / 2, f = w * s + s / 2;
        p.push([b, f]);
      }
    });
  });
  const A = {};
  return p.forEach(([v, k]) => {
    A[v] ? A[v].push(k) : A[v] = [k];
  }), Object.entries(A).map(([v, k]) => {
    const x = k.filter((w) => k.every((b) => !vn(w, b, s)));
    return [Number(v), x];
  }).forEach(([v, k]) => {
    k.forEach((x) => {
      a.push(M`<circle cx="${v}" cy="${x}" fill="${r}" r="${s / Rr}">`);
    });
  }), Object.entries(A).filter(([v, k]) => k.length > 1).map(([v, k]) => {
    const x = k.filter((w) => k.some((b) => vn(w, b, s)));
    return [Number(v), x];
  }).map(([v, k]) => {
    k.sort((w, b) => w < b ? -1 : 1);
    const x = [];
    for (const w of k) {
      const b = x.find((f) => f.some((P) => vn(w, P, s)));
      b ? b.push(w) : x.push([w]);
    }
    return [v, x.map((w) => [w[0], w[w.length - 1]])];
  }).forEach(([v, k]) => {
    k.forEach(([x, w]) => {
      a.push(M`<line x1="${v}" x2="${v}" y1="${x}" y2="${w}" stroke="${r}" stroke-width="${s / (Rr / 2)}" stroke-linecap="round">`);
    });
  }), a;
} }, xs = _`@keyframes fadeIn{0%{opacity:0}100%{opacity:1}}div{position:relative;user-select:none;display:block;overflow:hidden;width:100%;aspect-ratio:1/1;animation:fadeIn ease .2s}svg:first-child,w3m-wallet-image{position:absolute;top:50%;left:50%;transform:translateY(-50%) translateX(-50%)}w3m-wallet-image{transform:translateY(-50%) translateX(-50%)}w3m-wallet-image{width:25%;height:25%;border-radius:var(--w3m-wallet-icon-border-radius)}svg:first-child{transform:translateY(-50%) translateX(-50%) scale(.9)}svg:first-child path:first-child{fill:var(--w3m-accent-color)}svg:first-child path:last-child{stroke:var(--w3m-color-overlay)}`;
var Cs = Object.defineProperty, $s = Object.getOwnPropertyDescriptor, Tt = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? $s(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
let st = class extends C {
  ...
  svgTemplate() {
    ...
    return M`<svg height="${this.size}" width="${this.size}">${ys.generate(this.uri, this.size, this.size / 4, t)}</svg>`;
  }
  render() {
...
ke.styles = [I.globalCss, Es], Lr([y()], ke.prototype, "onChange", 2), ke = Lr([$("w3m-search-input")], ke);
const Is = _`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--w3m-accent-color)}`;
var Os = Object.defineProperty, _s = Object.getOwnPropertyDescriptor, Ts = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? _s(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
let nt = class extends C {
  ...
  render() {
    var e;
    return d`<button @click="${this.handleClick.bind(this)}"><div><w3m-wallet-image walletId="${this.walletId}" imageId="${this.imageId}"></w3m-wallet-image><w3m-text variant="xsmall-regular">${(e = this.label) != null ? e : g.getWalletName(this.name, !0)}</w3m-text>${this.sublabelTemplate()}</div></button>`;
  }
};
nt.styles = [I.globalCss, js], lt([y()], nt.prototype, "onClick", 2), lt([y()], nt.prototype, "name", 2), lt([y()], nt.prototype, "walletId", 2), lt([y()], nt.prototype, "label", 2), lt([y()], nt.prototype, "imageId", 2), lt([y()], nt.prototype, "installed", 2), lt([y()], nt.prototype, "recent", 2), nt = lt([$("w3m-wallet-button")], nt);
const Ws = _`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--w3m-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--w3m-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--w3m-color-bg-3)}#wallet-placeholder-dash{stroke:var(--w3m-color-overlay)}`;
var Us = Object.defineProperty, Hs = Object.getOwnPropertyDescriptor, Oe = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Hs(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
let Pt = class extends C {
  ...
  render() {
    var e;
    const t = (e = this.imageUrl) != null && e.length ? this.imageUrl : g.getWalletIcon({ id: this.walletId, image_id: this.imageId });
    return d`${t.length ? d`<div><img src="${t}" alt="${this.id}"></div>` : E.WALLET_PLACEHOLDER}`;
  }
};
Pt.styles = [I.globalCss, Ws], Oe([y()], Pt.prototype, "walletId", 2), Oe([y()], Pt.prototype, "imageId", 2), Oe([y()], Pt.prototype, "imageUrl", 2), Pt = Oe([$("w3m-wallet-image")], Pt);
var Zs = Object.defineProperty, Vs = Object.getOwnPropertyDescriptor, zs = (e, t, n, i) => {
  ...
  async fetchBalance(e) {
    if (z.state.enableAccountView)
      try {
        ...
        console.error(t), G.openToast(g.getErrorMessage(t), "error");
      }
  }
};
Dr = zs([$("w3m-account-context")], Dr);
var Fs = Object.defineProperty, Gs = Object.getOwnPropertyDescriptor, Br = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Gs(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Fs(t, n, r), r;
};
let xn = class extends C {
  constructor() {
    super(), this.preload = !0, this.preloadData();
  }
  async loadImages(e) {
    try {
      e != null && e.length && await Promise.all(e.map(async (t) => g.preloadImage(t)));
    } catch {
  ...
  async preloadListings() {
    ...
    if (z.state.enableExplorer) {
      ...
      const { recomendedWallets: n } = W.state, i = K.installedInjectedWallets(), r = (e = t == null ? void 0 : t.map((l) => g.getChainIcon(l.id))) != null ? e : [], o = n.map((l) => g.getWalletIcon(l)), a = i.map((l) => g.getWalletIcon(l));
...
Br([N()], xn.prototype, "preload", 2), xn = Br([$("w3m-explorer-context")], xn);
var Ks = Object.defineProperty, qs = Object.getOwnPropertyDescriptor, Wr = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? qs(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  ...
  async fetchBalance() {
    if (z.state.enableAccountView)
      try {
        ...
        console.error(e), G.openToast(g.getErrorMessage(e), "error");
      }
  }
};
Wr([N()], Cn.prototype, "activeChainId", 2), Cn = Wr([$("w3m-network-context")], Cn);
var Ys = Object.defineProperty, Js = Object.getOwnPropertyDescriptor, Qs = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Js(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Ys(t, n, r), r;
};
let Ur = class extends C {
  constructor() {
    super(), this.unsubscribeTheme = void 0, I.setTheme(), this.unsubscribeTheme = mt.subscribe(I.setTheme), this.preloadThemeImages();
  }
  disconnectedCallback() {
    var e;
...
Ur = Qs([$("w3m-theme-context")], Ur);
var Xs = Object.defineProperty, tl = Object.getOwnPropertyDescriptor, el = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? tl(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Xs(t, n, r), r;
};
const nl = 24e4, rl = 1e3;
var Hr;
let Zr = class extends C {
  constructor() {
    super(), this.unwatchOptions = void 0, this.unwatchAccount = void 0, this.unwatchWcConnection = void 0, this.timeout = void 0, this.isGenerated = !1, this.selectedChainId = (Hr = T.state.selectedChain) == null ? void 0 : Hr.id, this.isAccountConnected = D.state.isConnected, this.lastRetry = Date.now(), this.unwatchOptions = T.subscribe((e) => {
      var t, n;
    ...
    }), this.unwatchWcConnection = U.subscribe((e) => {
      e.pairingEnabled && !this.isGenerated && this.connectAndWait();
    });
  }
  disconnectedCallback() {
    var e, t, n;
    (e = this.unwatchOptions) == null || e.call(this), (t = this.unwatchAccount) == null || t.call(this), (n = this.unwatchWcConnection) == null || n.call(this);
  }
  async connectAndWait() {
    const { pairingEnabled: e } = U.state;
    if (clearTimeout(this.timeout), !this.isAccountConnected && e) {
      this.isGenerated = !0, this.timeout = setTimeout(this.connectAndWait.bind(this), nl);
      try {
        const { standaloneUri: t, selectedChain: n } = T.state;
        t ? U.setPairingUri(t) : await Z.client().connectWalletConnect((i) => U.setPairingUri(i), n == null ? void 0 : n.id);
      } catch (t) {
        console.error(t), U.setPairingError(!0), G.openToast("Connection request declined", "error"), Date.now() - this.lastRetry >= rl && (this.lastRetry = Date.now(), this.connectAndWait());
      }
    }
  }
};
Zr = el([$("w3m-wc-connection-context")], Zr);
const il = _`:host{all:initial}div{display:flex;align-items:center;background-color:var(--w3m-color-overlay);box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);border-radius:var(--w3m-button-border-radius);padding:4px 4px 4px 8px}div button{border-radius:var(--w3m-secondary-button-border-radius);padding:4px 8px;padding-left:4px;height:auto;margin-left:10px;color:var(--w3m-accent-fill-color);background-color:var(--w3m-accent-color)}.w3m-no-avatar{padding-left:8px}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--w3m-color-overlay)}button:hover::after{background-color:var(--w3m-color-overlay)}w3m-avatar{margin-right:6px}w3m-button-big w3m-avatar{margin-left:-5px}`;
var ol = Object.defineProperty, al = Object.getOwnPropertyDescriptor, $n = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? al(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && ol(t, n, r), r;
};
let te = class extends C {
  constructor() {
    super(), this.balance = "hide", this.avatar = "show", g.rejectStandaloneButtonComponent();
  }
  onOpen() {
    const { isStandalone: e } = T.state;
...
te.styles = [I.globalCss, il], $n([y()], te.prototype, "balance", 2), $n([y()], te.prototype, "avatar", 2), te = $n([$("w3m-account-button")], te);
const sl = _`button{display:flex;border-radius:var(--w3m-button-hover-highlight-border-radius);flex-direction:column;justify-content:center;padding:5px;width:100px}button:active{background-color:var(--w3m-color-overlay)}@media(hover:hover){button:hover{background-color:var(--w3m-color-overlay)}}button:disabled{pointer-events:none}w3m-network-image{width:32px;height:32px}w3m-text{margin-top:4px}`;
var ll = Object.defineProperty, cl = Object.getOwnPropertyDescriptor, En = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? cl(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && ll(t, n, r), r;
};
let ee = class extends C {
  constructor() {
...
ee.styles = [I.globalCss, sl], En([N()], ee.prototype, "chainId", 2), En([N()], ee.prototype, "label", 2), ee = En([$("w3m-account-network-button")], ee);
const dl = _`@keyframes slide{0%{background-position:0 0}100%{background-position:200px 0}}w3m-text{padding:1px 0}.w3m-loading{background:linear-gradient(270deg,var(--w3m-color-fg-1) 36.33%,var(--w3m-color-fg-3) 42.07%,var(--w3m-color-fg-1) 83.3%);background-size:200px 100%;background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation-name:slide;animation-duration:1.5s;animation-iteration-count:infinite;animation-timing-function:linear}`;
var hl = Object.defineProperty, ul = Object.getOwnPropertyDescriptor, ne = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? ul(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && hl(t, n, r), r;
};
let vt = class extends C {
  ...
  render() {
    ...
    return d`<w3m-text class="${F(n)}" variant="${t ? "medium-regular" : "big-bold"}" color="${t ? "inverse" : "primary"}">${this.name ? this.name : g.truncate((e = this.address) != null ? e : "")}</w3m-text>`;
  }
};
vt.styles = [I.globalCss, dl], ne([N()], vt.prototype, "address", 2), ne([N()], vt.prototype, "name", 2), ne([N()], vt.prototype, "loading", 2), ne([y()], vt.prototype, "variant", 2), vt = ne([$("w3m-address-text")], vt);
const V = { onConnecting(e) {
  ...
  return K.recomendedWallets(e).map((t) => d`<w3m-wallet-button name="${t.name}" walletId="${t.id}" imageId="${t.image_id}" .onClick="${() => this.onConnecting(t)}"></w3m-wallet-button>`);
...
let An = class extends C {
  ...
  render() {
    const { recomendedWallets: e } = W.state, t = [...e, ...e], n = V.externalWalletsTemplate(), i = V.installedInjectedWalletsTemplate(), r = [...i, ...n].length > 0, o = O.RECOMMENDED_WALLET_AMOUNT * 2;
...
An.styles = [I.globalCss, ml], An = fl([$("w3m-android-wallet-selection")], An);
const wl = _`@keyframes slide{0%{transform:translateX(-50px)}100%{transform:translateX(200px)}}.w3m-placeholder,img{border-radius:50%;box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);display:block;position:relative;overflow:hidden!important;background-color:var(--w3m-color-av-1);background-image:radial-gradient(at 66% 77%,var(--w3m-color-av-2) 0,transparent 50%),radial-gradient(at 29% 97%,var(--w3m-color-av-3) 0,transparent 50%),radial-gradient(at 99% 86%,var(--w3m-color-av-4) 0,transparent 50%),radial-gradient(at 29% 88%,var(--w3m-color-av-5) 0,transparent 50%);transform:translateZ(0)}.w3m-loader{width:50px;height:100%;background:linear-gradient(270deg,transparent 0,rgba(255,255,255,.4) 30%,transparent 100%);animation-name:slide;animation-duration:1.5s;transform:translateX(-50px);animation-iteration-count:infinite;animation-timing-function:linear;animation-delay:.55s}.w3m-small{width:24px;height:24px}.w3m-medium{width:60px;height:60px}`;
var vl = Object.defineProperty, bl = Object.getOwnPropertyDescriptor, re = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? bl(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
let bt = class extends C {
  ...
  render() {
    ...
    return this.avatar ? d`<img class="${F(e)}" src="${this.avatar}">` : this.address ? (g.generateAvatarColors(this.address), d`<div class="${F(e)}">${this.loading ? d`<div class="w3m-loader"></div>` : null}</div>`) : null;
  }
};
bt.styles = [I.globalCss, wl], re([N()], bt.prototype, "address", 2), re([N()], bt.prototype, "avatar", 2), re([N()], bt.prototype, "loading", 2), re([y()], bt.prototype, "size", 2), bt = re([$("w3m-avatar")], bt);
const yl = _`div{display:flex;align-items:center}w3m-token-image{width:28px;height:28px;margin-right:6px}`;
var xl = Object.defineProperty, Cl = Object.getOwnPropertyDescriptor, kn = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Cl(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && xl(t, n, r), r;
};
let ie = class extends C {
  constructor() {
    var e, t;
...
ie.styles = [I.globalCss, yl], kn([N()], ie.prototype, "symbol", 2), kn([N()], ie.prototype, "amount", 2), ie = kn([$("w3m-balance")], ie);
const $l = _`:host{all:initial}svg{width:28px;height:20px;margin:-1px 3px 0 -5px}svg path{fill:var(--w3m-accent-fill-color)}button:disabled svg path{fill:var(--w3m-color-fg-3)}w3m-spinner{margin:0 10px 0 0}`;
var El = Object.defineProperty, Al = Object.getOwnPropertyDescriptor, _e = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Al(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && El(t, n, r), r;
};
let Mt = class extends C {
  constructor() {
    super(), this.loading = !1, this.label = "Connect Wallet", this.icon = "show", this.modalUnsub = void 0, g.rejectStandaloneButtonComponent(), this.modalUnsub = J.subscribe((e) => {
...
let ct = class extends C {
  ...
  svgLoaderTemplate() {
    var e, t;
    const n = (t = (e = mt.state.themeVariables) == null ? void 0 : e["--w3m-wallet-icon-large-border-radius"]) != null ? t : I.getPreset("--w3m-wallet-icon-large-border-radius");
    let i = 0;
...
ct.styles = [I.globalCss, kl], St([y()], ct.prototype, "walletId", 2), St([y()], ct.prototype, "imageId", 2), St([y()], ct.prototype, "isError", 2), St([y()], ct.prototype, "isStale", 2), St([y()], ct.prototype, "label", 2), ct = St([$("w3m-connector-waiting")], ct);
var _l = Object.defineProperty, Tl = Object.getOwnPropertyDescriptor, Nt = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Tl(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && _l(t, n, r), r;
};
let yt = class extends C {
  constructor() {
    super(), this.isConnected = !1, this.label = "Connect Wallet", this.icon = "show", this.avatar = "show", this.balance = "hide", this.unsubscribeAccount = void 0, g.rejectStandaloneButtonComponent(), this.isConnected = D.state.isConnected, this.unsubscribeAccount = D.subscribe(({ isConnected: e }) => {
      this.isConnected = e;
    });
  }
  disconnectedCallback() {
...
Nt([N()], yt.prototype, "isConnected", 2), Nt([y()], yt.prototype, "label", 2), Nt([y()], yt.prototype, "icon", 2), Nt([y()], yt.prototype, "avatar", 2), Nt([y()], yt.prototype, "balance", 2), yt = Nt([$("w3m-core-button")], yt);
const Pl = _`.w3m-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.w3m-desktop-title,.w3m-mobile-title{display:flex;align-items:center}.w3m-mobile-title{justify-content:space-between;margin-bottom:20px;margin-top:-10px}.w3m-desktop-title{margin-bottom:10px;padding:0 10px}.w3m-subtitle{display:flex;align-items:center}.w3m-subtitle:last-child path{fill:var(--w3m-color-fg-3)}.w3m-desktop-title svg,.w3m-mobile-title svg{margin-right:6px}.w3m-desktop-title path,.w3m-mobile-title path{fill:var(--w3m-accent-color)}`;
var Ml = Object.defineProperty, Sl = Object.getOwnPropertyDescriptor, Nl = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Sl(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
let In = class extends C {
  render() {
    ...
    m ? u = c.slice(0, 3) : u = c;
    const h = !!u.length;
    return d`<w3m-modal-header .border="${!0}" title="Connect your wallet" .onAction="${g.handleUriCopy}" .actionIcon="${E.COPY_ICON}"></w3m-modal-header><w3m-modal-content><div class="w3m-mobile-title"><div class="w3m-subtitle">${E.MOBILE_ICON}<w3m-text variant="small-regular" color="accent">Mobile</w3m-text></div><div class="w3m-subtitle">${E.SCAN_ICON}<w3m-text variant="small-regular" color="secondary">Scan with your wallet</w3m-text></div></div><w3m-walletconnect-qr></w3m-walletconnect-qr></w3m-modal-content>${h ? d`<w3m-modal-footer><div class="w3m-desktop-title">${E.DESKTOP_ICON}<w3m-text variant="small-regular" color="accent">Desktop</w3m-text></div><div class="w3m-grid">${u} ${m ? d`<w3m-view-all-wallets-button></w3m-view-all-wallets-button>` : null}</div></w3m-modal-footer>` : null}`;
  }
};
In.styles = [I.globalCss, Pl], In = Nl([$("w3m-desktop-wallet-selection")], In);
const Rl = _`div{background-color:var(--w3m-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--w3m-color-bg-3);text-align:center}a{color:var(--w3m-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var Ll = Object.defineProperty, jl = Object.getOwnPropertyDescriptor, Dl = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? jl(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Ll(t, n, r), r;
};
...
On.styles = [I.globalCss, Rl], On = Dl([$("w3m-legal-notice")], On);
const Bl = _`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
var Wl = Object.defineProperty, Ul = Object.getOwnPropertyDescriptor, Hl = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Ul(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Wl(t, n, r), r;
};
let _n = class extends C {
  ...
  render() {
    ...
    m ? u = c.slice(0, 7) : u = c;
    const h = !!u.length;
    return d`<w3m-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${E.QRCODE_ICON}"></w3m-modal-header>${h ? d`<w3m-modal-content><div>${u} ${m ? d`<w3m-view-all-wallets-button></w3m-view-all-wallets-button>` : null}</div></w3m-modal-content>` : null}`;
  }
};
_n.styles = [I.globalCss, Bl], _n = Hl([$("w3m-mobile-wallet-selection")], _n);
const Zl = _`:host{all:initial}.w3m-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--w3m-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;background-color:rgba(0,0,0,.3);opacity:0;pointer-events:none}@media(max-height:720px) and (orientation:landscape){.w3m-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.w3m-active{pointer-events:auto}.w3m-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--w3m-background-border-radius) var(--w3m-background-border-radius) var(--w3m-container-border-radius) var(--w3m-container-border-radius);border:1px solid var(--w3m-color-overlay);overflow:hidden}.w3m-card{width:100%;position:relative;border-radius:var(--w3m-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--w3m-color-overlay);background-color:var(--w3m-color-bg-1);color:var(--w3m-color-fg-1)}@media(max-width:600px){.w3m-container{max-width:440px;border-radius:var(--w3m-background-border-radius) var(--w3m-background-border-radius) 0 0}.w3m-card{border-radius:var(--w3m-container-border-radius) var(--w3m-container-border-radius) 0 0}.w3m-overlay{align-items:flex-end}}@media(max-width:440px){.w3m-container{border:0}}`;
var Vl = Object.defineProperty, zl = Object.getOwnPropertyDescriptor, Tn = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? zl(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Vl(t, n, r), r;
};
let oe = class extends C {
  ...
  onOpenModalEvent() {
    this.toggleBodyScroll(!1), this.addKeyboardEvents(), this.open = !0, setTimeout(async () => {
      const e = g.isMobileAnimation() ? { y: ["50vh", "0vh"] } : { scale: [0.98, 1] }, t = 0.1, n = 0.2;
  ...
  async onCloseModalEvent() {
    ...
    const e = g.isMobileAnimation() ? { y: ["0vh", "50vh"] } : { scale: [1, 0.98] }, t = 0.2;
...
oe.styles = [I.globalCss, Zl], Tn([N()], oe.prototype, "open", 2), Tn([N()], oe.prototype, "active", 2), oe = Tn([$("w3m-modal")], oe);
const Fl = _`:host{all:initial}w3m-network-image{margin-left:-6px;margin-right:6px;width:28px;height:28px}`;
var Gl = Object.defineProperty, Kl = Object.getOwnPropertyDescriptor, Te = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Kl(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Gl(t, n, r), r;
};
let Rt = class extends C {
  constructor() {
    super(), this.chainId = "", this.label = "", this.wrongNetwork = !1, this.unsubscribeNetwork = void 0, g.rejectStandaloneButtonComponent();
    const { selectedChain: e } = T.state;
...
Lt.styles = [I.globalCss, ql], Pe([y()], Lt.prototype, "chainId", 2), Pe([y()], Lt.prototype, "isError", 2), Pe([y()], Lt.prototype, "label", 2), Lt = Pe([$("w3m-network-waiting")], Lt);
const Ql = _`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}w3m-button{margin:0 5px}`;
var Xl = Object.defineProperty, t0 = Object.getOwnPropertyDescriptor, xt = (e, t, n, i) => {
...
let ot = class extends C {
  ...
  onMobile() {
    O.isMobile() ? S.replace("MobileConnecting") : S.replace("MobileQrcodeConnecting");
  }
  onInjected() {
...
ot.styles = [I.globalCss, Ql], xt([y()], ot.prototype, "isMobile", 2), xt([y()], ot.prototype, "isInjected", 2), xt([y()], ot.prototype, "isInjectedInstalled", 2), xt([y()], ot.prototype, "isDesktop", 2), xt([y()], ot.prototype, "isWeb", 2), xt([y()], ot.prototype, "isRetry", 2), ot = xt([$("w3m-platform-selection")], ot);
const e0 = _`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--w3m-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.w3m-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--w3m-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--w3m-color-bg-2);box-shadow:inset 0 0 0 1px var(--w3m-color-overlay)}button:active{background-color:var(--w3m-color-overlay)}@media(hover:hover){button:hover{background-color:var(--w3m-color-overlay)}}.w3m-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--w3m-wallet-icon-border-radius)/ 2);border:1px solid var(--w3m-color-overlay)}.w3m-icons svg{width:21px;height:21px}.w3m-icons img:nth-child(1),.w3m-icons img:nth-child(2),.w3m-icons svg:nth-child(1),.w3m-icons svg:nth-child(2){margin-bottom:4px}w3m-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--w3m-color-bg-3)}#wallet-placeholder-dash{stroke:var(--w3m-color-overlay)}`;
var n0 = Object.defineProperty, r0 = Object.getOwnPropertyDescriptor, i0 = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? r0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
Pn.styles = [I.globalCss, e0], Pn = i0([$("w3m-view-all-wallets-button")], Pn);
const o0 = _`.w3m-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
var a0 = Object.defineProperty, s0 = Object.getOwnPropertyDescriptor, Me = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? s0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
let jt = class extends C {
  constructor() {
    super(), this.walletId = "", this.imageId = "", this.uri = "", this.unwatchWcConnection = void 0, setTimeout(() => {
      const { pairingUri: e } = U.state, { standaloneUri: t } = T.state;
      this.uri = t ?? e;
    }, 0), this.unwatchWcConnection = U.subscribe((e) => {
...
jt.styles = [I.globalCss, o0], Me([y()], jt.prototype, "walletId", 2), Me([y()], jt.prototype, "imageId", 2), Me([N()], jt.prototype, "uri", 2), jt = Me([$("w3m-walletconnect-qr")], jt);
const l0 = _`.w3m-profile{display:flex;justify-content:space-between;align-items:flex-start;padding-top:20px}.w3m-connection-badge{background-color:var(--w3m-color-bg-2);box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);padding:6px 10px 6px 26px;position:relative;border-radius:28px}.w3m-connection-badge::before{content:'';position:absolute;width:10px;height:10px;left:10px;background-color:var(--w3m-success-color);border-radius:50%;top:50%;margin-top:-5px;box-shadow:0 1px 4px 1px var(--w3m-success-color),inset 0 0 0 1px var(--w3m-color-overlay)}.w3m-footer{display:flex;justify-content:space-between}w3m-address-text{margin-top:10px;display:block}.w3m-balance{border-top:1px solid var(--w3m-color-bg-2);padding:11px 20px}`;
var c0 = Object.defineProperty, d0 = Object.getOwnPropertyDescriptor, h0 = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? d0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
Mn.styles = [I.globalCss, l0], Mn = h0([$("w3m-account-view")], Mn);
var u0 = Object.defineProperty, m0 = Object.getOwnPropertyDescriptor, p0 = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? m0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && u0(t, n, r), r;
};
let Sn = class extends C {
  viewTemplate() {
    return O.isAndroid() ? d`<w3m-android-wallet-selection></w3m-android-wallet-selection>` : O.isMobile() ? d`<w3m-mobile-wallet-selection></w3m-mobile-wallet-selection>` : d`<w3m-desktop-wallet-selection></w3m-desktop-wallet-selection>`;
  }
  render() {
    return d`${this.viewTemplate()}<w3m-legal-notice></w3m-legal-notice>`;
  }
};
Sn.styles = [I.globalCss], Sn = p0([$("w3m-connect-wallet-view")], Sn);
const g0 = _`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var f0 = Object.defineProperty, w0 = Object.getOwnPropertyDescriptor, Vr = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? w0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && f0(t, n, r), r;
};
let Se = class extends C {
  constructor() {
    super(), this.isError = !1, this.unwatchConnection = void 0, this.openDesktopApp(), this.unwatchConnection = U.subscribe((e) => {
  ...
  onFormatAndRedirect(e) {
    const { desktop: t, name: n } = O.getWalletRouterData(), i = t == null ? void 0 : t.native;
    if (i) {
  ...
  openDesktopApp() {
    U.setPairingError(!1);
    const { standaloneUri: e } = T.state, { pairingUri: t } = U.state, n = O.getWalletRouterData();
    g.setRecentWallet(n), e ? this.onFormatAndRedirect(e) : this.onFormatAndRedirect(t);
  }
  render() {
    const { name: e, id: t, image_id: n } = O.getWalletRouterData(), { isMobile: i, isInjected: r, isWeb: o } = g.getCachedRouterWalletPlatforms();
    return d`<w3m-modal-header title="${e}" .onAction="${g.handleUriCopy}" .actionIcon="${E.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${t}" imageId="${n}" label="${`Continue in ${e}...`}" .isError="${this.isError}"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`Connection can continue loading if ${e} is not installed on your device`}</w3m-text><w3m-platform-selection .isMobile="${i}" .isInjected="${r}" .isWeb="${o}" .isRetry="${!0}"><w3m-button .onClick="${this.openDesktopApp.bind(this)}" .iconRight="${E.RETRY_ICON}">Retry</w3m-button></w3m-platform-selection></w3m-info-footer>`;
  }
};
Se.styles = [I.globalCss, g0], Vr([N()], Se.prototype, "isError", 2), Se = Vr([$("w3m-desktop-connecting-view")], Se);
const v0 = _`.w3m-info-text{margin:5px 0 15px;max-width:320px;text-align:center}.w3m-wallet-item{margin:0 -20px 0 0;padding-right:20px;display:flex;align-items:center;border-bottom:1px solid var(--w3m-color-bg-2)}.w3m-wallet-item:last-child{margin-bottom:-20px;border-bottom:0}.w3m-wallet-content{margin-left:20px;height:60px;display:flex;flex:1;align-items:center;justify-content:space-between}.w3m-footer-actions{display:flex;flex-direction:column;align-items:center;padding:20px 0;border-top:1px solid var(--w3m-color-bg-2)}w3m-wallet-image{display:block;width:40px;height:40px;border-radius:10px}`;
var b0 = Object.defineProperty, y0 = Object.getOwnPropertyDescriptor, x0 = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? y0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
let Rn = class extends C {
  ...
  onGet() {
    z.state.enableExplorer ? S.push("GetWallet") : g.openWalletExplorerUrl();
  }
  onLearnMore() {
...
Rn.styles = [I.globalCss, C0], Rn = A0([$("w3m-help-view")], Rn);
const k0 = _`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var I0 = Object.defineProperty, O0 = Object.getOwnPropertyDescriptor, zr = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? O0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && I0(t, n, r), r;
};
let Ne = class extends C {
  ...
  async openInjectedApp() {
    ...
    e && (this.isError = !1, await g.handleConnectorConnection("injected", () => {
      this.isError = !0;
    }));
  }
  render() {
    const { name: e, id: t, image_id: n } = O.getWalletRouterData(), { isMobile: i, isDesktop: r, isWeb: o } = g.getCachedRouterWalletPlatforms();
...
Ne.styles = [I.globalCss, k0], zr([N()], Ne.prototype, "isError", 2), Ne = zr([$("w3m-injected-connecting-view")], Ne);
const _0 = _`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}w3m-button{margin-top:15px}`;
var T0 = Object.defineProperty, P0 = Object.getOwnPropertyDescriptor, M0 = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? P0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
let Ln = class extends C {
  ...
  render() {
    const { name: e, id: t, image_id: n, homepage: i } = O.getWalletRouterData();
...
let Re = class extends C {
  constructor() {
    super(), this.isError = !1, this.unwatchConnection = void 0, this.openMobileApp(), this.unwatchConnection = U.subscribe((e) => {
      this.isError = e.pairingError;
    });
  }
  disconnectedCallback() {
  ...
  onFormatAndRedirect(e, t = !1) {
    const { mobile: n, name: i } = O.getWalletRouterData(), r = n == null ? void 0 : n.native, o = n == null ? void 0 : n.universal;
    if (r && !t) {
  ...
  openMobileApp(e = !1) {
    U.setPairingError(!1);
    const { standaloneUri: t } = T.state, { pairingUri: n } = U.state, i = O.getWalletRouterData();
    g.setRecentWallet(i), t ? this.onFormatAndRedirect(t, e) : this.onFormatAndRedirect(n, e);
  }
  onGoToAppStore(e) {
    e && O.openHref(e, "_blank");
  }
  render() {
    const { name: e, id: t, image_id: n, app: i, mobile: r } = O.getWalletRouterData(), { isWeb: o } = g.getCachedRouterWalletPlatforms(), a = i == null ? void 0 : i.ios, l = r == null ? void 0 : r.universal;
...
Re.styles = [I.globalCss, S0], Fr([N()], Re.prototype, "isError", 2), Re = Fr([$("w3m-mobile-connecting-view")], Re);
const L0 = _`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var j0 = Object.defineProperty, D0 = Object.getOwnPropertyDescriptor, B0 = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? D0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
...
let jn = class extends C {
  render() {
    const { name: e, id: t, image_id: n } = O.getWalletRouterData(), { isInjected: i, isDesktop: r, isWeb: o } = g.getCachedRouterWalletPlatforms();
    return d`<w3m-modal-header title="${e}" .onAction="${g.handleUriCopy}" .actionIcon="${E.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-walletconnect-qr walletId="${t}" imageId="${n}"></w3m-walletconnect-qr></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`Scan this QR Code with your phone's camera or inside ${e} app`}</w3m-text><w3m-platform-selection .isDesktop="${r}" .isInjected="${i}" .isWeb="${o}"></w3m-platform-selection></w3m-info-footer>`;
  }
};
jn.styles = [I.globalCss, L0], jn = B0([$("w3m-mobile-qr-connecting-view")], jn);
var W0 = Object.defineProperty, U0 = Object.getOwnPropertyDescriptor, H0 = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? U0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && W0(t, n, r), r;
};
let Dn = class extends C {
  render() {
    return d`<w3m-modal-header title="Scan the code" .onAction="${g.handleUriCopy}" .actionIcon="${E.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-walletconnect-qr></w3m-walletconnect-qr></w3m-modal-content>`;
  }
};
Dn.styles = [I.globalCss], Dn = H0([$("w3m-qrcode-view")], Dn);
const Z0 = _`div{display:grid;grid-template-columns:repeat(4,80px);margin:-5px -10px;justify-content:space-between}w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-info-footer w3m-text{text-align:center}`;
var Pi = Object.defineProperty, V0 = Object.defineProperties, z0 = Object.getOwnPropertyDescriptor, F0 = Object.getOwnPropertyDescriptors, Gr = Object.getOwnPropertySymbols, G0 = Object.prototype.hasOwnProperty, K0 = Object.prototype.propertyIsEnumerable, Kr = (e, t, n) => t in e ? Pi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, q0 = (e, t) => {
  for (var n in t || (t = {}))
    G0.call(t, n) && Kr(e, n, t[n]);
  if (Gr)
    for (var n of Gr(t))
      K0.call(t, n) && Kr(e, n, t[n]);
  return e;
}, Y0 = (e, t) => V0(e, F0(t)), Bn = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? z0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Pi(t, n, r), r;
};
let ae = class extends C {
  constructor() {
  ...
  render() {
    const { chains: e } = T.state, t = e == null ? void 0 : e.map((i) => Y0(q0({}, i), { unsupported: this.isUnsuportedChainId(i.id) })), n = t == null ? void 0 : t.sort((i, r) => Number(i.unsupported) - Number(r.unsupported));
...
ae.styles = [I.globalCss, Z0], Bn([N()], ae.prototype, "connectedChains", 2), Bn([N()], ae.prototype, "isUnsupportedChains", 2), ae = Bn([$("w3m-select-network-view")], ae);
const J0 = _`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}w3m-button{margin-top:15px}`;
var Q0 = Object.defineProperty, X0 = Object.getOwnPropertyDescriptor, qr = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? X0(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && Q0(t, n, r), r;
};
...
let Ct = class extends C {
  ...
  isLastPage() {
    ...
    return i <= Wn || n.length >= i;
  }
  async fetchWallets() {
    var e;
    const { wallets: t, search: n, injectedWallets: i } = W.state, { listings: r, total: o, page: a } = this.search ? n : t;
    if (!this.endReached && (this.firstFetch || o > Wn && r.length < o))
      try {
        this.loading = !0;
        const l = (e = T.state.standaloneChains) == null ? void 0 : e.join(","), { listings: s } = await W.getWallets({ page: this.firstFetch ? 1 : a + 1, entries: Wn, search: this.search, version: T.state.walletConnectVersion, chains: l }), c = s.map((u) => g.getWalletIcon(u)), m = i.map((u) => g.getWalletIcon(u));
        await Promise.all([...c.map(async (u) => g.preloadImage(u)), ...m.map(async (u) => g.preloadImage(u)), O.wait(300)]), this.endReached = this.isLastPage();
      } catch (l) {
        console.error(l), G.openToast(g.getErrorMessage(l), "error");
      } finally {
  ...
  render() {
    ...
    r && (o = o.filter(({ values: u }) => g.caseSafeIncludes(u[0], this.search)), a = a.filter(({ values: u }) => g.caseSafeIncludes(u[0], this.search)), l = l.filter(({ values: u }) => g.caseSafeIncludes(u[0], this.search))), o = o.filter((u) => !l.find((h) => g.caseSafeIncludes(u.values[0], h.values[0])));
    const s = !this.loading && !n.length && !o.length && !l.length, c = Math.max(o.length, n.length), m = { "w3m-loading": i, "w3m-end-reached": this.endReached || !this.loading, "w3m-empty": s };
    return d`<w3m-modal-header><w3m-search-input .onChange="${this.onSearchChange.bind(this)}"></w3m-search-input></w3m-modal-header><w3m-modal-content class="${F(m)}"><div class="w3m-grid">${i ? null : l} ${i ? null : [...Array(c)].map((u, h) => d`${a[h]} ${o[h]} ${n[h] ? d`<w3m-wallet-button imageId="${n[h].image_id}" name="${n[h].name}" walletId="${n[h].id}" .onClick="${() => this.onConnect(n[h])}"></w3m-wallet-button>` : null}`)}</div><div class="w3m-placeholder-block">${s ? d`<w3m-text variant="big-bold" color="secondary">No results found</w3m-text>` : null} ${!s && this.loading ? d`<w3m-spinner></w3m-spinner>` : null}</div></w3m-modal-content>`;
  }
};
Ct.styles = [I.globalCss, t1], se([N()], Ct.prototype, "loading", 2), se([N()], Ct.prototype, "firstFetch", 2), se([N()], Ct.prototype, "search", 2), se([N()], Ct.prototype, "endReached", 2), Ct = se([$("w3m-wallet-explorer-view")], Ct);
const r1 = _`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var i1 = Object.defineProperty, o1 = Object.getOwnPropertyDescriptor, Yr = (e, t, n, i) => {
  for (var r = i > 1 ? void 0 : i ? o1(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (r = (i ? a(t, n, r) : a(r)) || r);
  return i && r && i1(t, n, r), r;
};
let je = class extends C {
  constructor() {
    super(), this.isError = !1, this.unwatchConnection = void 0, this.openWebWallet(), this.unwatchConnection = U.subscribe((e) => {
      this.isError = e.pairingError;
    });
  }
  disconnectedCallback() {
  ...
  onFormatAndRedirect(e) {
    const { desktop: t, name: n } = O.getWalletRouterData(), i = t == null ? void 0 : t.universal;
    if (i) {
  ...
  render() {
    const { name: e, id: t, image_id: n } = O.getWalletRouterData(), { isMobile: i, isInjected: r, isDesktop: o } = g.getCachedRouterWalletPlatforms(), a = O.isMobile();
...
je.styles = [I.globalCss, r1], Yr([N()], je.prototype, "isError", 2), je = Yr([$("w3m-web-connecting-view")], je);
export {
