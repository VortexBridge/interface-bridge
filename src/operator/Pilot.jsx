...
export default function Pilot({ client, enabled }) {
  ...
  return <Stack gap={2}>
    ...
    <Gate title="Synthetic route exercises" complete={false} detail="Bidirectional quorum, unexpected outage, maintenance, disagreement, persistence failure, coordinator loss, restart, backup restore and fenced replacement remain pending until all three operators are enrolled." />
    ...
    <Paper variant="outlined" sx={{ p: { xs: 2, sm: 3 } }}>
      <Stack gap={2}>
        ...
        <Typography>The terminal returns the signed public declaration. Keep raw host evidence, endpoints and credentials outside Git. Share only the signed declaration and separately reviewed sanitized evidence summary.</Typography>
      </Stack>
    </Paper>
